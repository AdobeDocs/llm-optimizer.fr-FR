...
+ Fondamentaux de LLM Optimizer{#essentials}
  + [Vue d’ensemble de LLM Optimizer](/help/overview/overview.md)
  + [Démarrage rapide](/help/overview/quick-start.md)
  + [Bonnes pratiques](/help/tutorials/best-practices.md)
  + [Bonnes pratiques pour les catégories, rubriques, prompts et autres marques à suivre](/help/overview/best-practices-topics-prompts.md)
+ Tableaux de bord{#dashboards}
  + [Vue d’ensemble des tableaux de bord](/help/dashboards/dashboards-overview.md)
  ...
  + Opportunités{#opportunities}
    ...
    + [Ajouter des FAQ pertinentes](/help/dashboards/opportunities/add-relevant-faqs.md)
    + [Ajouter des résumés de transcription multimédia](/help/dashboards/opportunities/add-multimedia-transcript-summaries.md)
...
+ Ressources supplémentaires{#resources}
  + Optimize at Edge{#optimize-at-edge}
    ...
    + [Portail d’Azure (BYOCDN)](/help/dashboards/optimize-at-edge/azure-front-door-byocdn.md)
    + [Serveur HTTP Apache](/help/dashboards/optimize-at-edge/apache-http-server.md)
  + [Contrôle d’accès](/help/dashboards/access-control.md)
  + [Intégration d’Adobe Analytics](/help/dashboards/adobe-analytics-integration.md)
  + [Intégration de Google Analytics](/help/dashboards/google-analytics-integration.md)
