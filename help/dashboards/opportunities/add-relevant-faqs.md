...
Le tableau **URL avec suggestions** répertorie les pages où les questions fréquentes peuvent aider à la découverte pilotée par l’IA. Les suggestions sont organisées en **Suggestions actuelles**, **Suggestions fixes** et **Suggestions ignorées**. Pour chaque URL, vous pouvez effectuer les opérations suivantes :
