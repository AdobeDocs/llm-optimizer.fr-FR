...
1. Sur le tableau de bord **Configuration du client** n, sélectionnez l’onglet **Configuration du réseau CDN**.
...
| CloudFront (BYOCDN) | Apporter votre propre réseau CDN | [Afficher le guide de configuration](/help/dashboards/optimize-at-edge/cloudfront-byocdn.md) |
